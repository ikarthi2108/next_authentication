...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setLoggingIn(true); // Set loggingIn to true when submitting the form
    ...
    try {
      ...
      setLoggingIn(false); // Set loggingIn back to false after receiving the response
    }
  };
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                disabled={loggingIn} // Disable the input field when logging in
          ...
          <div className="text-center mt-4">
            <button
              type="submit"
              disabled={loggingIn} // Disable the button when logging in
